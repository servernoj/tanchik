<template lang="pug">
  .page
    h1 Background
    p
      | I was born and raised in Russia where I got my formal education and my first MS degree in Fine Arts. I moved to USA in 2008 and took some time to figure out what I wanted to do next. In 2011 I decided to get another degree in Computer Science. I completed my Master Degree in Computer Science in 2015, got Graduate Certificate in Data Management and Analytics in 2018 and still learn new ways of how to manipulate and visualize data. As of now, I am working as a Data Analyst and enjoy learning new technology that helps me to achieve my goals.
